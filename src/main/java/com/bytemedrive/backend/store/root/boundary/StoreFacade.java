...
import com.bytemedrive.backend.store.esdb.boundary.EsdbFacade;
...
public class StoreFacade {
    ...
    public CompletableFuture<Void> publishEvent(Object event) {
        var esdb = facadeEsdb.publishEvent(event);
        return CompletableFuture.allOf(esdb);
    }
